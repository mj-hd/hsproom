...
func Init() {
	...
	Router.Register("/api/program/shared_data/read/", apiProgramSharedDataReadHandler)
	Router.RegisterApi("/api/program/shared_data/write/", apiProgramSharedDataWriteHandler)
	Router.RegisterApi("/api/program/shared_data/delete/", apiProgramSharedDataDeleteHandler)
	Router.RegisterApi("/api/program/shared_data/list/", apiProgramSharedDataListHandler)
